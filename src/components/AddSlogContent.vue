    ...
    methods: {
        ...
        submitForm(formName) {
            ...
            if (valid) {
                ...
                console.log(data)
                this.$axios.post('http://127.0.0.1:4523/m1/1038100-0-default/slog/addSlog',data).then((response)=>{
      ...
      submitForm2(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$axios.post('http://127.0.0.1:9090/slog/addSlog',data).then((response)=>{
                if(response.data.code=='201'){
                    this.$message({
                        message:response.data.message,
                        type:'success'
