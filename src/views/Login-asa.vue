  ...
  <div class="register-box">
    ...
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="120px" class="login-container" autocomplete="off">
        <el-form-item label="用户学号/工号" prop="schoolId" class="clickPosition">
          <el-input v-model="ruleForm.schoolId" autocomplete="off"></el-input>
        </el-form-item>
  
        <el-form-item label="密码" prop="password" class="clickPosition">
          <el-input type="password" v-model="ruleForm.password" autocomplete="off" show-password></el-input>
        </el-form-item>
        <a href="#" @click="toLogin('ruleForm')" style="margin-left:50px">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
        ...
        <router-link to="/register" style="margin-left:150px">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
        ...
        <!-- <br>
        <br> -->
        <!-- <el-button type="primary" style="color:aliceblue;border: 0;margin-right: 40px;margin-left: 50px;" @click="toAdmin"><i class="el-icon-user"></i>管理员登录</el-button> -->
      ...
      toLogin(formName){
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$axios.post('http://127.0.0.1:4523/m1/1038100-0-default/user/login',data).then((response)=>{
              if(response.data.code == '201'){
                ...
                window.sessionStorage.setItem('userId',response.data.data.schoolId);
                ...
                window.sessionStorage.setItem('rank',response.data.data.rank);
